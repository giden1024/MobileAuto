...
def get_code(code_msg):
    code = re.findall(r".*(\d{6})", code_msg)[0]
    return code


def get_press_key(code):  # key为键盘需要输入的内容，value是press_keycode的对应code
    key = {'0': 7, '1': 8, '2': 9, '3': 10, '4': 11, '5': 12, '6': 13, '7': 14, '8': 15, '9': 16,
           'A': 29, 'business': 30, 'C': 31, 'D': 32, 'E': 33, 'F': 34, 'G': 35, 'H': 36, 'I': 37, 'J': 38,
